...
const Card = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(({ className, ...props }, ref) => (
  <div ref={ref} className={cn("rounded-3xl border border-white/60 bg-white/80 backdrop-blur-xl shadow-glass text-card-foreground overflow-hidden transition-all duration-300 hover:shadow-xl", className)} {...props} />
));
